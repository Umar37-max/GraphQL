...
class DeleteAuthor(graphene.Mutation):
    class Arguments:
        id = graphene.ID(required=True)  # Assuming you're using an ID for identifying the author

    success = graphene.Boolean()  # Return a boolean indicating if the deletion was successful
    author = graphene.Field(AuthorType)  # Optionally return the deleted author
    ...
    def mutate(self, info, id):
        try:
            ...
            return DeleteAuthor(success=False, author=None)
